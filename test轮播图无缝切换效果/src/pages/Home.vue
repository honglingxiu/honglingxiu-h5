  ...
  export default {
    ...
    methods: {
      ...
      toggleImageWall(index) {
        ...
        if (index >= 0) {
          ...
          var wallItemArr = document.querySelectorAll(".wall-item-hook");
          for (var i = 0; i < wallItemArr.length; i++) {
            wallItemArr[i].style.width = (this.wallLiWidth-10)+"px";
          }
    ...
    mounted() {
      this.$nextTick(() => {
        ...
        this.wallLiWidth2 = document.documentElement.clientWidth;
      });
    },
    watch: {
