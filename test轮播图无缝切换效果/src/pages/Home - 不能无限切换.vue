  ...
  methods:{
    ...
    toggleImageWall(index){
      ...
      if(index>=0){
        ...
        this.translateX=this.wallLiWidth*this.currentIndex;
        this.$refs.wallList.style.width=this.wallLiWidth*this.imgArr.length+"px";//设置wallList的长度
    ...
    setWallList(){//wallList最终的位置
      ...
      liDotArr[this.currentIndex].className="dot-item dot-item-hook actived";
